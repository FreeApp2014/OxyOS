Public Class PV_LoadUrl
    Private Sub PV_LoadUrl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Owner = Desktop
    End Sub
    Private Sub TextBox4_Enter(sender As Object, e As EventArgs) Handles TextBox4.Enter
        If TextBox4.Text = "URL" Then
            TextBox4.Text = ""
            Label6.Visible = True
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        PictureViewer.LoadExt(TextBox4.Text)
        Me.Close()
    End Sub
